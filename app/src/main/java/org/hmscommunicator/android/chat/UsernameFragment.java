 ...
 * @since 2020-01-13
 */
public class UsernameFragment extends Fragment implements PermissionInterface, View.OnClickListener {
    ...
    private RelativeLayout usernamesRl;
...
//    }
    ...
    private void connect(View view) {
        ...
        usernamesRl.setVisibility(View.GONE);
    }
